...
# Workaround for WordPress hard-coded URLs (in case of any URL changes throughout life of project)
...
ALBDNSNAME=$(aws ssm get-parameter --name "/A4L/Wordpress/ALBDNSNAME" \
--query "Parameter.Value" --output text)
NEW_URL=$ALBDNSNAME
